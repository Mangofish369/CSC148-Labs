"""CSC148 Lab 2: Object-Oriented Programming
...
class User:
    ...
    def hack(self) -> None:
        ...
        """
        # TODO: implement this!
        # get every user this user follows
        # get their tweets
        # change their tweet to mwahahaha

        for followers in self.follows:
            for tweet in followers.tweets:
